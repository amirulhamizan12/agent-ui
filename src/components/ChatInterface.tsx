          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <div className={`w-2 h-2 rounded-full ${
                ...
                sessionStatus === 'creating' ? 'bg-yellow-500 animate-pulse' : 
                'bg-red-500'
              }`}></div>
          ...
          <div className="text-center text-gray-400 mt-8">
            {sessionStatus === 'none' ? (
              <div className="space-y-4">
                <p>Welcome! Start by creating a browser session</p>
                <button
            ...
            <div className="flex items-center space-x-2">
              {sessionStatus === 'active' && !state.isRunning && (
                <button
                  ...
                  className="text-blue-400 hover:text-blue-300 text-sm flex items-center space-x-1 px-2 py-1 rounded hover:bg-dark-400 transition-colors"
                >
