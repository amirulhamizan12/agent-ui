...
import { Clock, FileText, Globe, CheckCircle, Share2, ExternalLink } from 'lucide-react'
      ...
      <div className="h-full flex items-center justify-center">
        <div className="text-center max-w-md">
          ...
          <p className="text-gray-400">
            Task results and summary will appear here once complete
          </p>
        </div>
      </div>
    )
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="bg-dark-200 border border-dark-300 rounded-lg p-6">
          ...
          {state.executionSummary ? (
            <div className="prose prose-invert max-w-none prose-headings:text-white prose-p:text-gray-300 prose-li:text-gray-300 prose-strong:text-white prose-em:text-gray-200">
              ...
              >
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">Generating task summary...</span>
                </div>
            ...
            <p className="text-gray-400">Task summary will be generated upon completion.</p>
          )}
        </div>
